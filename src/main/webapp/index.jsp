...
<%--        %>--%>
    ...
    <p class="lead">
        ...
        Små lækre cupcakes eller muffins er skønne, som portionsservering af dejlige kageopskrifter. Sådan en cupcake passer perfekt
        til et koldt glas mælk en eftermiddag, eller til en varm kop kaffe, som dessert efter et godt måltid.
        Jeg synes det er vigtigt at selve kagen i en cupkage smager vidunderligt – det nytter ikke noget bare at pynte den flot … egentlig er jeg ikke den store kagepynter og det er ret begrænset, hvad der er af kagepyntsinspiration, fondant og den slags her på bloggen, men grunddelen – selve muffinskagen – er i top, og så må du endelig pynte den lige som du har lyst.
